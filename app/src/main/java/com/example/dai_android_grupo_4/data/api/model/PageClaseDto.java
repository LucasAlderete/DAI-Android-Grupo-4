...
public class PageClaseDto {
    
    @SerializedName("content")
    private List<ClaseDto> content;
    ...
    // Getters y Setters
    public List<ClaseDto> getContent() { return content; }
    public void setContent(List<ClaseDto> content) { this.content = content; }
